 ...
 * Тоже про удаление deleteRow и beforeDeleteRow/afterDeleteRow. Проверка перед удалением должна выдавать осмысленный совет
 * в плане "А то теперь делать", раз удалить нельзя.
...
/** Список полей*/
	public $fields = [];
/** Последний добавленный ключ - после сохранения строки с ключом 0 в этой переменной будет новый id записи*/
