...
/** Запись отдаваемая по ключу == 0, как правило для заполнения формы нового экземпляра сущности
 * @return array Дефолтные значения для новой записи.
 * TODO/в процессе: придумать как быстро заполнять числовые поля нулями. тупо лезть в описание таблиц - долго.
 */
 ...
 * */
	public function getList(array $params = []): array
	{
		...
		$params['order'] = (empty($params['order'])) ? $this->key_field : $params['order'];
