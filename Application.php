 ...
 *
 * 1. Контроллер
 * В приложении создается контроллер, вызывается его конструктор (а в нем и все его предки)
 * Контроллеру устанавливаются поля $this->running_method_name (а также модуль и класс)
 ...
 * Случаи должны быть редкими и обоснованными. Основанием может быть одноразовость кода, либо полное отсутсвие инфы о
 ...
 * * Контроллер не знает о представлении ничего и никак не влияет на его поля, напротив представление знает обо всех полях контроллера.
 *
 * В представлениях:
