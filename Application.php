 ...
 * 3. сформировать ФАЙЛ (или бинарную пременную) и отдать контроллеру. Вывод в Эксель - это НЕ представление данных.
 *
 * Модели НЕ ДОЛЖНЫ ничего знать об авторизации.
 *
 *
 *
 *
